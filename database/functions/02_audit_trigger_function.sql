...
BEGIN
    ...
    v_client_id := get_audit_client_id();

    v_reason := get_audit_reason();
    ...
    -- --------------------------------------------------------
    -- Obtain PostgreSQL transaction identifier
    -- --------------------------------------------------------
